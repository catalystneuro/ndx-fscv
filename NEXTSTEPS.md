...
# Next Steps for ndx-fscv Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-fscv directory: `cd ndx-fscv`
...
`spec/ndx-fscv.namespace.yaml` and
`spec/ndx-fscv.extensions.yaml` files.

6. Define API classes for your new extension data types.

    - As a starting point, `src/pynwb/ndx_fscv/__init__.py` includes an
...
`src/pynwb/ndx_fscv/tests` or `src/matnwb/tests`.
...
`src/pynwb/ndx_fscv/widgets` so that the visualizations can be displayed with
[nwbwidgets](https://github.com/NeurodataWithoutBorders/nwbwidgets).
You will also need to update the `vis_spec` dictionary in 
`src/pynwb/ndx_fscv/widgets/__init__.py` so that
...
2. Start a git repository for your extension directory ndx-fscv
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/weiglszonja/ndx-fscv/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).
...
9. Publish your updated extension on [PyPI](https://pypi.org/).
    ...
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-fscv/0.1.0
...
`staged-extensions/ndx-fscv`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-fscv
    ```

13. Edit `staged-extensions/ndx-fscv/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      name: ndx-fscv
      version: 0.1.0
      src: https://github.com/weiglszonja/ndx-fscv
      pip: https://pypi.org/project/ndx-fscv/
      license: MIT
      maintainers: 
        - weiglszonja
      ```

14. Edit `staged-extensions/ndx-fscv/README.md`
to add information about your extension. You may copy it from
`ndx-fscv/README.md`.

  ```bash
  cp ndx-fscv/README.md staged-extensions/ndx-fscv/README.md
  ```
...
git add ndx-fscv
git commit -m "Add new catalog entry for ndx-fscv" .
git push
```
...
ndx-fscv-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-fscv GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-fscv-record repository on GitHub.
